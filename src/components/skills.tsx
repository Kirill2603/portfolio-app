...
export const Skills = () => {
    ...
    const skills = [
        ...
        {id: 7, skill: "CSS Frameworks", progress: 70},
    ...
    return (
        <>
            ...
            <Flex justify={"space-between"} direction={"row"} pb={2} key={skill.id}>
                <Center bg='green.300' w={'15%'} h={'48px'} minW={"min-content"}>
                    {skill.skill}
                </Center>
                <Progress colorScheme='green' h={'48px'} value={skill.progress} hasStripe w={'100%'} />
